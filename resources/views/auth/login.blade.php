                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="content-top-agile p-10">
                            <h2 class="text-white">Bienvenido Puede Iniciar sesión</h2>
                        ...
                        <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" id="email" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Correo Electrónico" :value="old('email')" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Contraseña" required autocomplete="current-password">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <div class="fog-pwd text-right">
                                            <a href="{{ route('password.request') }}" class="text-white hover-info"><i class="ion ion-locked"></i> ¿Olvidaste la contraseña?</a><br>
                                        </div>
                                    </div>
                                    <!-- /.col -->
                            ...
                            <!-- <div class="text-center text-white">
                                <p class="mt-20">- Iniciar sesión usando -</p>
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0 text-white">¿No tienes una cuenta?s <a href="{{ route('register') }}" class="hover-info ml-5">Registrarse</a></p>
                            </div>
                        </div>
                    </div>
                </div>
