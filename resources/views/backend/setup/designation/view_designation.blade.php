                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <a href="{{ route('designation.add') }}" style="float: right;" class="btn btn-rounded btn-success mb-5"> Agregar cargo</a>
                        </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('designation.edit', $designation->id) }}" class="btn btn-info">Cambiar</a>
