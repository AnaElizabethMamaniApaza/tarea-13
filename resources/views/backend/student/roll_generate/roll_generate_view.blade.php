                    ...
                    <div class="col-12">
                        <div class="box bb-3 border-info">
                            <div class="box-header">
                                <h4 class="box-title">Lista de estudiantes <strong>Estudiante</strong></h4>
                            </div>
                                ...
                                <form method="post" action="{{ route('roll.generate.store') }}">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="year_id" id="year_id" class="form-control">
                                                        <option value="" selected="" disabled="">Seleccionar Año
                                                        </option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="class_id" id="class_id" class="form-control">
                                                        <option value="" selected="" disabled="">Seleccionar Clase
                                                        </option>
                                        ...
                                        <div class="col-md-4" style="padding-top: 21px;">
                                            <a href="#" id="search" class="btn btn-primary" name="search">
                                                Estudiante</a>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" class="btn btn-info" value="Generador de Listas">
                                </form>
                            </div>
                        </div>
