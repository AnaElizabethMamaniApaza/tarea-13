...
class RegistrationFeeController extends Controller
{
    ...
    public function RegFeeClassData(Request $request)
    {
        ...
        foreach ($allStudent as $key => $v) {
            ...
            $html[$key]['tdsource'] .= '<a class="btn btn-sm btn-' . $color . '" title="PaySlip" target="_blanks" href="' . route("student.registration.fee.payslip") . '?class_id=' . $v->class_id . '&student_id=' . $v->student_id . '">Comprobante de Pago</a>';
            $html[$key]['tdsource'] .= '</td>';
        }
